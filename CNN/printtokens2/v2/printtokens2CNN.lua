...
function create_network()
   ...
   ann:add(nn.TemporalConvolution(1,10,26))   -- 482*1 goes in, 457*10 goes out
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  228*10 
   ann:add(nn.ReLU())  
   
   ann:add(nn.TemporalConvolution(10,5,25))  -- 228*10 goes in, 204*5 goesout
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  102*5 
   ann:add(nn.ReLU())  

   ann:add(nn.View(102*5))
   ann:add(nn.Linear(102*5,300))
   ann:add(nn.ReLU())
