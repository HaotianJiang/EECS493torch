...
local training_dataset = loadtxt('printtokens2_parameter.txt','print_tokens2_label1.txt')
local testing_dataset  = loadtxt('printtokens2_testingSet.txt','printtokens2_testingLabel.txt')
--a={{1,2,2},{3,4,5}}
--print("one data")    
