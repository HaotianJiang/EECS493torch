...
function create_network()
   ...
   ann:add(nn.TemporalConvolution(1,10,26))   -- 293*1 goes in, 268*10 goes out
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  134*10 
   ann:add(nn.ReLU())  
   
   ann:add(nn.TemporalConvolution(10,5,25))  -- 134*10 goes in, 110*5 goesout
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  55*10 
   ann:add(nn.ReLU())  

   ann:add(nn.View(55*5))
   ann:add(nn.Linear(55*5,300))
   ann:add(nn.ReLU())
