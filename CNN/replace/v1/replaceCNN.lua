...
function create_network()
   ...
   ann:add(nn.TemporalConvolution(1,10,27))   -- 458*1 goes in, 432*10 goes out
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  216*10 
   ann:add(nn.ReLU())  
   
   ann:add(nn.TemporalConvolution(10,5,27))  -- 216*10 goes in, 190*5 goesout
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  95*5 
   ann:add(nn.ReLU())  

   ann:add(nn.View(95*5))
   ann:add(nn.Linear(95*5,300))
   ann:add(nn.ReLU())
