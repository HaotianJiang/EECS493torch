...
function create_network()
   ...
   ann:add(nn.TemporalConvolution(1,10,26))   -- 253*1 goes in, 228*10 goes out
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  114*10 
   ann:add(nn.ReLU())  
   
   ann:add(nn.TemporalConvolution(10,5,25))  -- 114*10 goes in, 90*5 goesout
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  45*5 
   ann:add(nn.ReLU())  

   ann:add(nn.View(45*5))
   ann:add(nn.Linear(45*5,300))
   ann:add(nn.ReLU())
