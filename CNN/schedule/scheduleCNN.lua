...
function create_network()
   ...
   ann:add(nn.TemporalConvolution(1,10,26))   -- 281*1 goes in, 256*10 goes out
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  128*10 
   ann:add(nn.ReLU())  
   
   ann:add(nn.TemporalConvolution(10,5,25))  -- 128*10 goes in, 104*5 goesout
   ann:add(nn.TemporalMaxPooling(2)) -- becomes  52*5 
   ann:add(nn.ReLU())  

   ann:add(nn.View(52*5))
   ann:add(nn.Linear(52*5,200))
   ann:add(nn.ReLU())
   ann:add(nn.Linear(200,2))
   ann:add(nn.ReLU())
