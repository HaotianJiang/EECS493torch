...
local training_dataset = loadtxt('schedule_parameter.txt','schedule_label2.txt')
local testing_dataset  = loadtxt('schedule_testingSet.txt','schedule_testingLabel.txt')
--a={{1,2,2},{3,4,5}}
--print("one data")    
