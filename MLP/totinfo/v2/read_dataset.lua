...
local training_dataset = loadtxt('totinfo_parameter.txt','totinfo_label2.txt')
local testing_dataset  = loadtxt('totinfo_testingSet.txt','totinfo_testingLabel.txt')
--a={{1,2,2},{3,4,5}}
--print("one data")    
