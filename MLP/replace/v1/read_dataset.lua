...
local training_dataset = loadtxt('replace_parameter.txt','replace_label1.txt')
local testing_dataset  = loadtxt('replace_testingSet.txt','replace_testingLabel.txt')
--a={{1,2,2},{3,4,5}}
--print("one data")    
