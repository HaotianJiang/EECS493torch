...
local training_dataset = loadtxt('schedule2_parameter.txt','schedule2_label1.txt')
local testing_dataset  = loadtxt('schedule2_testingSet.txt','schedule2_testingLabel.txt')
--a={{1,2,2},{3,4,5}}
--print("one data")    
